...
/* Generated from ../O.Common/HVTest.dbd */
...
int HVTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/lab324/EPICS/base-3.14.12.5/HV";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"HVTest_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    HVTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
